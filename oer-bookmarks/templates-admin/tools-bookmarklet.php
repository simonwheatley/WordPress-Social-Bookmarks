...
<div class="tool-box">
	...
	<p class="pressthis"><a onclick="return false;" oncontextmenu="if(window.navigator.userAgent.indexOf('WebKit')!=-1)jQuery('.pressthis-code').show().find('textarea').focus().select();return false;" href="<?php echo htmlspecialchars( $bookmarklet_link ); ?>"><span><?php _e('Bookmark This', 'oerb') ?></span></a></p>
